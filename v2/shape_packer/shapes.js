...
// Resize the shape
//-------------------------------------------------------------------------------------------------
Shape.prototype.Resize = function (delta)
{
    this.SetSize (Math.abs (this.scale + delta));
}
//-------------------------------------------------------------------------------------------------
...
// cv is an object containing:
//      chelp: a CanvasHelp instance
//      dx: The x-offset to apply to the shape
//      dy: The y-offset to apply to the shape
//      scale: The scale factor to apply
//      image: The image element
//-------------------------------------------------------------------------------------------------
Shape.prototype.ToCanvas = function (cv, fill)
{
    var msg = "Abstract function \"ToCanvas\" called";
    throw msg;
}
//-------------------------------------------------------------------------------------------------
